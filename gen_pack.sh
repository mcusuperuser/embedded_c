...
# Version: 1.0 
# Date: 2019-08-16
# This bash script generates a CMSIS-Pack:
#
# Pre-requisites:
# - bash shell (Under Windows it is recommended to use WSL/Ubuntu)
...
#   e.g. Ubuntu: sudo apt-get install libxml-utils2
# - pandoc in path
#   e.g. Ubuntu: sudo apt-get install pandoc
...
if [ `uname -s` = "Linux" ]
  then
  CMSIS_PACK_PATH="/mnt/c/Keil_v5/ARM/PACK/ARM/CMSIS/5.6.0/"
...
# Copy PDSC file to pack/ directory
cp mcusuperuser.embedded_c.pdsc $PACK_WAREHOUSE
